...
DESTINATIONS = [
  {:arrive_date => Date.new(2013,8,30), :leave_date => Date.new(2013,8,30), :location => 'Melbourne'},
  ...
  {:arrive_date => Date.new(2013,9,12), :leave_date => Date.new(2013,9,13), :location => 'Beijing'},
