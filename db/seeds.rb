...
Travel.create(:departure => Time.new(2013,8,30,11,0,0, '+11:00'),
  :arrival => Time.new(2013,8,31,1,10,0, '+11:00'),
  :number => 'JQ7',
  :mode => 'Flying',
  :stopover => 'Singapore')
Travel.create(:departure => Time.new(2013,9,4,20,30,0, '+11:00'),
  :arrival => Time.new(2013,9,5,9,0,0, '+11:00'),
  :number => 'T43',
  :mode => 'Training',
  :stopover => nil)
Travel.create(:departure => Time.new(2013,9,7,12,15,0, '+11:00'),
  :arrival => Time.new(2013,9,7,14,15,0, '+11:00'),
  :number => 'CA1215',
  :mode => 'Flying',
  :stopover => nil)
Travel.create(:departure => Time.new(2013,9,11,16,55,0, '+11:00'),
  :arrival => Time.new(2013,9,11,19,15,0, '+11:00'),
  :number => ' CA1518',
  :mode => 'Flying',
  :stopover => nil)
Travel.create(:departure => Time.new(2013,9,14,2,40,0, '+11:00'),
  :arrival => Time.new(2013,9,15,6,45,0, '+11:00'),
  :number => ' CJQ8',
  :mode => 'Flying',
  :stopover => 'Singapore')
